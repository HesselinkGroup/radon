import numpy as np
from radon.fan2para import map_fan2para, map_para2fan
...
def test_fan_para_inversion():
    ...
    for t,p in zip(tt.ravel(), pp.ravel()):
        ...
        r, theta = map_fan2para(p, t, d_src)
        p2, t2 = map_para2fan(r, theta, d_src)
